...
<body>
    ...
    function cari($keyword) {
        ...
        $query = "SELECT * FROM pesan WHERE nama LIKE '%$keyword%'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td><a href='lihat_pesan.php?nama_pengirim=" . $row['nama_pengirim'] . "'>Lihat</a></td>";
            echo "</tr>";
        }
    } else {
        echo "<tr><td colspan='5'>Tidak ada data penduduk.</td></tr>";
    }        
    ...
    <div class="action-container">
        <button onclick="window.print()">Cetak Data Pesan</button> 
    </div>
                </div>
            </main>
        </div>
