...
?>
<!DOCTYPE html>
<html lang="nama_kegiatan">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="wnama_kegiatanth=device-wnama_kegiatanth, initial-scale=1.0">
...
<body>
    ...
    <nav>
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <form action="" method="post">
                    <input type="text" name="keyword" size="30" autofocus placeholder="Masukkan Nama Kegiatan Kegiatan yang akan dicari.." autocomplete="off">
                    <button type="submit" name="cari">Cari!</button>
                </form>
            <br><br>
                <a href="tambah_data_kegiatan.html" style="text-decoration: none;">
                <button style="padding: 10px 20px; background-color: #4CAF50; color: white; border: none; cursor: pointer; border-radius: 5px;">Tambah Data Kegiatan</button>
                </a>
            <br><br>
        <table>
        <tr>
        ...
        function cari($keyword) {
            ...
            $query = "SELECT * FROM data_kegiatan WHERE nama_kegiatan LIKE '%$keyword%'";
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><img src='kegiatan/" . $row['foto'] . "' alt='Foto Kegiatan' style='width: 75px; height: auto;'></td>";
                echo "<td><a href='edit_data_kegiatan.php?nama_kegiatan=" . $row['nama_kegiatan'] . "'>Edit</a> | <a href='hapus_data_kegiatan.php?nama_kegiatan=" . $row['nama_kegiatan'] . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data kegiatan ini?\")'>Hapus</a></td>";
                echo "</tr>";
            }
        } else {
            echo "<tr><td colspan='11'>Tidak ada kegiatan.</td></tr>";
        }        
    ...
    <div class="action-container">
        <button onclick="window.print()">Cetak Data Kegiatan</button> 
    </div>
                </div>
            </main>
        </div>
