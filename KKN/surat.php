...
<body>
    ...
    <div class="dashboard">
        <div class="card yellow">
            ...
            <a href="surat_keterangan_usaha.php">Buat Surat</a>
        </div>
        <div class="card blue">
            <i class="fas fa-file-alt"></i>
            <h3>Surat Keterangan Harga Tanah</h3>
            <a href="surat_keterangan_harga_tanah.php">Buat Surat</a>
        </div>
        <div class="card green">
            <i class="fas fa-file-alt"></i>
            <h3>Surat Keterangan Kematian</h3>
            <a href="surat_keterangan_kematian.php">Buat Surat</a>
        </div>
        <div class="card orange">
            <i class="fas fa-file-alt"></i>
            <h3>Surat Kuasa</h3>
            <a href="surat_kuasa.php">Buat Surat</a>
        </div>
        <div class="card purple">
            <i class="fas fa-file-alt"></i>
            <h3>Surat Keterangan Ahli Waris</h3>
            <a href="surat_keterangan_ahli_waris.php">Buat Surat</a>
        </div>
    </div>
</main>
        </div>
