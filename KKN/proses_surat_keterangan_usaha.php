...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    <body>
        ...
        <div class='isi-surat'>
            Yang bertanda tangan di bawah ini, Kepala Kampung Gayau Sakti Kecamatan Seputih Agung Kabupaten Lampung Tengah, dengan ini menerangkan bahwa:
            <table>
                <tr><td>Nama</td><td>: $nama_pelaku_usaha</td></tr>
            ...
            Menerangkan bahwa benar nama tersebut di atas penduduk Kampung Gayau Sakti Kecamatan Seputih Agung Kabupaten Lampung Tengah yang sedang berusaha di bidang: <br>
            <div style='text-align: center; font-weight: bold;'><br>$nama_usaha</div>
            <br>
            Demikian surat keterangan usaha ini kami buat dengan sebenarnya dan untuk dipergunakan sebagaimana mestinya.
        </div>
